...
curl -sL "$BASE_URL/agents/@testing.md" -o "$DEST/@testing.md"
echo "   ✓ @testing.md"
...
curl -sL "$BASE_URL/commands/test.md" -o "$DEST/test.md"
echo "   ✓ test.md"
...
echo "   /test             - Run automated tests (audit + E2E)"
echo ""
...
echo "   /@testing   - Testing automation expert"
echo ""
